...
public class PropertyDialog extends Frame implements ActionListener{
	...
	public static String buFont = PropertyData.font;  // �o�b�t�@�p
	public static int buFontSize = PropertyData.fontSize; // �o�b�t�@�p
	public static String buColor = PropertyData.color; // �o�b�t�@�p
	public static String buBackgroundColor = PropertyData.backgroundColor; // �o�b�t�@�p
