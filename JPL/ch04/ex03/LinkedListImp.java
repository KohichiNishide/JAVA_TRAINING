...
public class LinkedListImp implements Cloneable, LinkedList{
	private Item head;
	private int size;
	...
	public LinkedListImp clone() throws CloneNotSupportedException {
		LinkedListImp list = (LinkedListImp)super.clone();
		return list;
	}
